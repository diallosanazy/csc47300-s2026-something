// ── Menu Page – Render dynamically added items ───────────
// Reads items from sessionStorage (non-persistent, gone on refresh).
// Also makes ALL cards (hardcoded + dynamic) clickable → detail page.
