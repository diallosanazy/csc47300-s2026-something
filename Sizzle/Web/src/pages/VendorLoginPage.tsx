    ...
    <div className="c2019817c">
      <div className="c477430cc">
        ...
        <div className="c72b7280d">
          <div className="c408846e3">Run<br />your food<br />business.</div>
          <div className="c74dc3fc1">Access orders, menus, and analytics in one place.</div>
        </div>
      </div>
      <div className="cfa34f91a">
        <form className="ca71a26f0" onSubmit={handleSubmit}>
          <div className="c00507de5">Welcome back</div>
          <div className="ce0a55529">Sign in to your vendor account</div>
          ...
          <div className="c9e1cc4e3">
            ...
            <div className="c580783d8">
              <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="you@example.com" style={{ background: 'none', border: 'none', color: '#1C1917', fontSize: 15, outline: 'none', width: '100%' }} />
            </div>
          </div>
          <div className="cac95cb05">
            ...
            <div className="cb3bb90c7">
              <input type="password" value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" style={{ background: 'none', border: 'none', color: '#1C1917', fontSize: 15, outline: 'none', width: '100%' }} />
            </div>
          </div>
          ...
          <div className="c0452cf75">
            ...
            <Link className="link-reset cae99bc63" to="/vendor-register">
              <div className="c101d052c">New vendor?</div>
              <div className="c1ae11093">Create vendor account</div>
            </Link>
          </div>
        </form>
      </div>
